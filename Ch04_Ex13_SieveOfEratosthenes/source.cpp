/* @brief Assignment from chapter 4 exercise 13.
...
int main()
{
	int maxNumber = 100; // the maximum number based on the exercise
	cout << "This application returns the primes between the numbers 1 and 100." << endl;
