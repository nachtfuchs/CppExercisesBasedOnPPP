/* @brief Assignment from chapter 7 the Exercise 5.
 * Book: Programming Principle and Practice using C++ - Stroustrup
 *
 * ASSINGMENT:
 * Modify Token_stream::get() to return Token(print) when it sees a
 * newline. This implies looking for whitespace characters and
 * treating newline ('\n') specially. You might find the standard
 * library function isspace(ch), which returns true if ch is a
 * whitespace character, useful.
 */
