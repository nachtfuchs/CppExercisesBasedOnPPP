...
// Constructor
Patron::Patron( string inFirstName, string inLastName, double inCardNumber, double inFee)
	: firstName {inFirstName}, lastName {inLastName}, cardNumber {inCardNumber}, fee {inFee}
{}
